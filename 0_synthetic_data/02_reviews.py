...
REVIEW_TEMPLATES = {
    5: [
        "Absolutely amazing {dishes}! The {highlight} was cooked to perfection. Fresh ingredients and authentic British flavors. Highly recommend!",
        ...
        "Best pub food in England! {dishes} were incredible. {highlight} had the perfect homemade taste. Five stars!",
        "Exceptional quality! Ordered {dishes} and everything was delicious. The {highlight} was perfectly cooked. Proper British comfort food!",
        "Wow! Just wow! {dishes} were all fantastic. {highlight} was particularly memorable. Can't wait to order again!",
        "Hands down the best {highlight} I've ever had! {dishes} were all prepared beautifully. Fresh and hearty!",
        "Incredible meal! {dishes} arrived hot and fresh. The {highlight} was absolutely divine. Proper Sunday roast quality!",
        "Perfect in every way! {dishes} were all excellent. {highlight} stood out with its rich, traditional taste.",
        "Lovely grub! The {dishes} were spot on. {highlight} was bellissimo (as my Italian neighbor would say)!",
        "Cracking good food! {dishes} arrived piping hot. The {highlight} was proper comfort food. Will be back!",
    ],
    4: [
        ...
        "Good quality food. {dishes} were nicely done. {highlight} could have been slightly more seasoned but still good!",
        "Pleasant meal! {dishes} arrived warm. {highlight} was tasty though not exceptional. Would order again.",
        "Pretty decent pub grub. {dishes} hit the spot. {highlight} was good value for money.",
        "Solid British comfort food. {dishes} were enjoyable. {highlight} could use more gravy next time!",
    ],
    3: [
        "Decent food but nothing special. {dishes} were okay. {highlight} lacked the wow factor I expected.",
        ...
        "Typical average takeaway. {dishes} were okay but nothing to write home about. {highlight} was meh.",
    ],
    2: [
        ...
        "Expected better. {dishes} were subpar. {highlight} was too greasy. Stomach upset followed.",
        "Not impressed. {dishes} arrived soggy. {highlight} was clearly microwaved. Disappointing for British food.",
    ],
    1: [
        ...
        "Appalling quality! {dishes} were swimming in grease. {highlight} was raw inside. Health hazard!",
        "Shocking! {dishes} bore no resemblance to the menu description. {highlight} was inedible. Refund demanded!",
        "Absolutely rubbish! {dishes} were cold and soggy. {highlight} tasted like cardboard. Avoid this place!",
    ]
}
...
def generate_customer_reviews(review_percentage=0.35):
    ...
    # Rating distribution (slightly different for British palette)
    rating_weights = {
        5: 0.48,  # Slightly lower than Indian version
        4: 0.27,
        3: 0.13,
        2: 0.07,
        1: 0.05
